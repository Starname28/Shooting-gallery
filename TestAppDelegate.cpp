...
void TestAppDelegate::RegisterTypes()
{
	...
	//
	REGISTER_WIDGET_XML(GameWidget, "TestWidget");
}
...
void TestAppDelegate::OnPostDraw() {
	...
	//Render::PrintString(WINDOW_WIDTH/2, WINDOW_HEIGHT/10, std::string("MY: ") + utils::lexical_cast(Core::appInstance->GetCurrentFps()), 3.0f, RightAlign, BottomAlign);
